...
contract("MarketPlace", accounts => {
    ...
    it("should create an apartment successfully", async () => {
        ...
        await marketPlace.createApartment(accounts[0], title, name, description, target, deadline, image);
        ...
        assert.equal(result[0].target.toString(), target.toString(), "target is not correct");
